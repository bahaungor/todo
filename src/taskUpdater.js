...
function addFunctionalityToTasks() {
    document
        .querySelectorAll('.task-container #task-done')
        .forEach((a) => a.addEventListener('change', completeTask))

    document
        .querySelectorAll('.task-container #task-importance')
        .forEach((a) => a.addEventListener('change', favoriteTask))
}
